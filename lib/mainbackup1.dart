    ...
    bottomNavigationBar: Container(
      ...
      child: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.water_drop, size: 20), label: 'Sensor'),
          BottomNavigationBarItem(icon: Icon(Icons.settings_input_component, size: 20), label: 'Pompa'),
          BottomNavigationBarItem(icon: Icon(Icons.gamepad, size: 20), label: 'Manual'),
          BottomNavigationBarItem(icon: Icon(Icons.history, size: 20), label: 'Log'),
          BottomNavigationBarItem(icon: Icon(Icons.settings, size: 20), label: 'Pengaturan'),
        ],
      ),
    ),
  );
